...
(function () {
    ...
    const gameTetris = "tetris";
    const gameSnake = "snake";
    const gameSameGame = "samegame";
    ...
    function fCheckKey(e) {
        ...
        switch (e.key) {
            ...
            case "Enter":
                ...
                if ( fClassList(pControls).contains(gameSameGame)) {
                    dir = "fire";
                }
                break;
            case " ":
    ...
    function initWebSocket() {
        ...
        webSocket.onmessage = function(e) {
            ...
            if (e.data && e.data.indexOf('GameOver') >= 0) {
                ...
                // falls GameOver von Controller generiert wurde
                if (e.data.indexOf(gameTetris) >= 0) {
                    game = gameTetris;
                } else if (e.data.indexOf(gameSnake) >= 0) {
                    game = gameSnake;
                } else if (e.data.indexOf(gameSameGame) >= 0) {
                    game = gameSameGame;
                }
                if (score === highscore) {
