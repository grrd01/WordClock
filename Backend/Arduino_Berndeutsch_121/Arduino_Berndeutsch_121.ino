        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            if (header.indexOf("snake") >= 0) {
              ...
              // Script
              client.println("<script>!function(){let e,s,t,a=1,n=1,i=0,o=255,c=0,d=0,r=0,l=0;function u(e){return document.getElementById(e)}function w(e){return localStorage.getItem(e)}function g(e,s){return localStorage.setItem(e,s)}const L=u(\"clock\"),m=u(\"pageClock\"),p=u(\"pageSettings\"),f=u(\"pageSnake\"),v=u(\"color\"),M=u(\"speed\");function h(){i&&(o&&!d?(o-=1,c+=1):c?(c-=1,d+=1):(d-=1,o+=1),b(\"rgb(\"+o+\", \"+c+\", \"+d+\")\"),setTimeout(h,M.value/10))}function k(e){a=e,a?document.getElementsByTagName(\"body\")[0].classList.remove(\"off\"):document.getElementsByTagName(\"body\")[0].classList.add(\"off\"),t=-1}function b(e){document.documentElement.style.setProperty(\"--main-color\",e)}function E(e){e!==i&&(u(\"rainbowMode\").children[0].classList.toggle(\"hide\"),u(\"rainbowMode\").children[1].classList.toggle(\"hide\")),i=e,i?h():b(v.value)}function y(e){e!==n&&(u(\"darkMode\").children[0].classList.toggle(\"hide\"),u(\"darkMode\").children[1].classList.toggle(\"hide\")),n=e}function _(){let e=parseInt(v.value.substring(1,3),16),s=parseInt(v.value.substring(3,5),16),t=parseInt(v.value.substring(5,7),16);if(g(\"wc_color\",v.value),g(\"wc_rainbow\",i),g(\"wc_darkmode\",n),g(\"wc_speed\",M.value.toString()),window.location.href.includes(\"192.168.\")||window.location.href.includes(\".local\")){let o=new XMLHttpRequest;o.open(\"GET\",\"/update_params?red=\"+e+\"&green=\"+s+\"&blue=\"+t+\"&rainbow=\"+i+\"&darkmode=\"+n+\"&speed=\"+M.value+\"&power=\"+a,!0),o.send()}}function S(e){let s=new XMLHttpRequest;s.onreadystatechange=function(){4===this.readyState&&200===this.status&&(r=10*(parseInt(s.responseText)-3),r>l&&(l=r,g(\"wc_score\",l)),u(\"scoreSnake\").innerHTML=\"Score: \"+r+\" / High-Score : \"+l)},s.open(\"GET\",\"snake?dir=\"+e,!0),s.send()}if(setInterval((function(){e=new Date,n&&(e.getHours()>=22||e.getHours()<7)?document.getElementsByTagName(\"body\")[0].classList.add(\"dark\"):document.getElementsByTagName(\"body\")[0].classList.remove(\"dark\"),t!==e.getMinutes()&&(t=e.getMinutes(),L.classList.remove(...L.classList),0!==a&&(t>=55?L.classList.add(\"M5\",\"MV\"):t>=50?L.classList.add(\"M10\",\"MV\"):t>=45?L.classList.add(\"M15\",\"MV\"):t>=40?L.classList.add(\"M20\",\"MV\"):t>=35?L.classList.add(\"M5\",\"MA\",\"M30\"):t>=30?L.classList.add(\"M30\"):t>=25?L.classList.add(\"M5\",\"MV\",\"M30\"):t>=20?L.classList.add(\"M20\",\"MA\"):t>=15?L.classList.add(\"M15\",\"MA\"):t>=10?L.classList.add(\"M10\",\"MA\"):t>=5&&L.classList.add(\"M5\",\"MA\"),s=e.getHours(),t>=25&&(s+=1),s%=12,L.classList.add(\"H\"+s.toString()),L.classList.add(\"M\"+(t%5).toString())))}),100),u(\"power\").addEventListener(\"click\",(function(){k(1-a),_()})),u(\"settings\").addEventListener(\"click\",(function(){document.activeElement.blur(),m.classList.remove(\"swipe-out-right\"),p.classList.remove(\"swipe-in-left\"),m.classList.add(\"swipe-out\"),p.classList.add(\"swipe-in\")})),u(\"settingsClose\").addEventListener(\"click\",(function(){_(),m.classList.remove(\"swipe-out\"),p.classList.remove(\"swipe-in\"),p.classList.remove(\"swipe-out-right\"),m.classList.add(\"swipe-out-right\"),p.classList.add(\"swipe-in-left\")})),u(\"playSnake\").addEventListener(\"click\",(function(){document.activeElement.blur(),p.classList.remove(\"swipe-out-right\"),f.classList.remove(\"swipe-in-left\"),p.classList.add(\"swipe-out\"),f.classList.add(\"swipe-in\"),S(5)})),u(\"exitSnake\").addEventListener(\"click\",(function(){p.classList.remove(\"swipe-out\"),f.classList.remove(\"swipe-in\"),p.classList.add(\"swipe-out-right\"),f.classList.add(\"swipe-in-left\"),S(6)})),Array.from(document.getElementsByClassName(\"snakeButton\")).forEach((function(e){e.addEventListener(\"click\",(function(e){S(e.target.getAttribute(\"data-num\"))}))})),document.onkeydown=function(e){let s=0;switch(e.key){case\"ArrowUp\":s=1;break;case\"ArrowRight\":s=2;break;case\"ArrowDown\":s=3;break;case\"ArrowLeft\":s=4}s&&(S(s),u(\"control\").children[s-1].classList.add(\"glow\"),setTimeout((function(){u(\"control\").children[s-1].classList.remove(\"glow\")}),200))},v.addEventListener(\"change\",(e=>{b(v.value)}),!1),u(\"rainbowMode\").addEventListener(\"click\",(e=>{E(1-i)})),u(\"darkMode\").addEventListener(\"click\",(e=>{y(1-n)})),w(\"wc_color\")&&(v.value=w(\"wc_color\"),b(v.value)),w(\"wc_rainbow\")&&E(parseInt(w(\"wc_rainbow\"))),w(\"wc_darkmode\")&&y(parseInt(w(\"wc_darkmode\"))),w(\"wc_speed\")&&(M.value=parseInt(w(\"wc_speed\"))),w(\"wc_score\")&&(l=w(\"wc_score\")),u(\"iphone\").href=u(\"icon\").href,window.location.href.includes(\"192.168.\")||window.location.href.includes(\".local\")){let e=new XMLHttpRequest;e.onreadystatechange=function(){if(4===this.readyState&&200===this.status){let n=JSON.parse(e.responseText);n.rainbow||(v.value=(s=n.red,t=n.green,a=n.blue,\"#\"+(1<<24|s<<16|t<<8|a).toString(16).slice(1))),b(v.value),y(n.darkmode),E(n.rainbow),k(n.power),M.value=n.speed}var s,t,a},e.open(\"GET\",\"get_params\",!0),e.send()}else u(\"snakeBody\").classList.add(\"hide\")}();</script></body></html>");
            }
