        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            if (header.indexOf("snake") >= 0) {
              ...
              // Script
              client.println("<script>!function(){\"use strict\";let e,t,s,a=1,n=0,i=255,o=0,c=0,d=0,r=0;function l(e){return document.getElementById(e)}function u(e){return localStorage.getItem(e)}function L(e,t){return localStorage.setItem(e,t)}const w=l(\"clock\"),p=l(\"pageClock\"),g=l(\"pageSettings\"),h=l(\"pageSnake\"),m=l(\"color\"),v=l(\"speed\");function f(){n&&(i&&!c?(i-=1,o+=1):o?(o-=1,c+=1):(c-=1,i+=1),M(\"rgb(\"+i+\", \"+o+\", \"+c+\")\"),setTimeout(f,v.value/10))}function M(e){document.documentElement.style.setProperty(\"--main-color\",e)}function k(e){e!==n&&(l(\"rainbowMode\").children[0].classList.toggle(\"hide\"),l(\"rainbowMode\").children[1].classList.toggle(\"hide\")),n=e,n?f():M(m.value)}function b(e){e!==a&&(l(\"darkMode\").children[0].classList.toggle(\"hide\"),l(\"darkMode\").children[1].classList.toggle(\"hide\")),a=e}function E(e){let t=new XMLHttpRequest;t.onreadystatechange=function(){4===this.readyState&&200===this.status&&(d=10*(parseInt(t.responseText)-3),d>r&&(r=d,L(\"wc_score\",r)),l(\"scoreSnake\").innerHTML=\"Score: \"+d+\" / High-Score : \"+r)},t.open(\"GET\",\"snake?dir=\"+e,!0),t.send()}if(setInterval((function(){e=new Date,a&&(e.getHours()>=22||e.getHours()<7)?document.getElementsByTagName(\"body\")[0].classList.add(\"dark\"):document.getElementsByTagName(\"body\")[0].classList.remove(\"dark\"),s!==e.getMinutes()&&(s=e.getMinutes(),w.classList.remove(...w.classList),s>=55?w.classList.add(\"M5\",\"MV\"):s>=50?w.classList.add(\"M10\",\"MV\"):s>=45?w.classList.add(\"M15\",\"MV\"):s>=40?w.classList.add(\"M20\",\"MV\"):s>=35?w.classList.add(\"M5\",\"MA\",\"M30\"):s>=30?w.classList.add(\"M30\"):s>=25?w.classList.add(\"M5\",\"MV\",\"M30\"):s>=20?w.classList.add(\"M20\",\"MA\"):s>=15?w.classList.add(\"M15\",\"MA\"):s>=10?w.classList.add(\"M10\",\"MA\"):s>=5&&w.classList.add(\"M5\",\"MA\"),t=e.getHours(),s>=25&&(t+=1),t%=12,w.classList.add(\"H\"+t.toString()),w.classList.add(\"M\"+(s%5).toString()))}),100),l(\"settings\").addEventListener(\"click\",(function(){document.activeElement.blur(),p.classList.remove(\"swipe-out-right\"),g.classList.remove(\"swipe-in-left\"),p.classList.add(\"swipe-out\"),g.classList.add(\"swipe-in\")})),l(\"settingsClose\").addEventListener(\"click\",(function(){let e=parseInt(m.value.substring(1,3),16),t=parseInt(m.value.substring(3,5),16),s=parseInt(m.value.substring(5,7),16);if(p.classList.remove(\"swipe-out\"),g.classList.remove(\"swipe-in\"),g.classList.remove(\"swipe-out-right\"),p.classList.add(\"swipe-out-right\"),g.classList.add(\"swipe-in-left\"),L(\"wc_color\",m.value),L(\"wc_rainbow\",n),L(\"wc_darkmode\",a),L(\"wc_speed\",v.value.toString()),window.location.href.includes(\"192.168.\")){let i=new XMLHttpRequest;i.open(\"GET\",\"/update_params?red=\"+e+\"&green=\"+t+\"&blue=\"+s+\"&rainbow=\"+n+\"&darkmode=\"+a+\"&speed=\"+v.value,!0),i.send()}})),l(\"searchClock\").addEventListener(\"click\",e=>{l(\"searchClock\").style.pointerEvents=\"none\",function e(t,s){let a=new XMLHttpRequest;a.onreadystatechange=function(){4===this.readyState&&(200===this.status&&a.responseText.startsWith(\"WORDCLOCK\")?(l(\"searchLabel\").innerHTML=\"Ha se gfunde: http://192.168.\"+t+\".\"+s,setTimeout((function(){window.open(\"http://192.168.\"+t+\".\"+s,\"_self\")}),3e3)):(256===++s&&(t++,s=0),t<256&&(l(\"searchLabel\").innerHTML=\"Hie isch si nid: http://192.168.\"+t+\".\"+s,e(t,s))))},a.timeout=300,a.open(\"GET\",\"http://192.168.\"+t+\".\"+s+\"/ping\",!0),a.send()}(0,0)}),l(\"playSnake\").addEventListener(\"click\",(function(){document.activeElement.blur(),g.classList.remove(\"swipe-out-right\"),h.classList.remove(\"swipe-in-left\"),g.classList.add(\"swipe-out\"),h.classList.add(\"swipe-in\"),E(5)})),l(\"exitSnake\").addEventListener(\"click\",(function(){g.classList.remove(\"swipe-out\"),h.classList.remove(\"swipe-in\"),g.classList.add(\"swipe-out-right\"),h.classList.add(\"swipe-in-left\"),E(6)})),Array.from(document.getElementsByClassName(\"snakeButton\")).forEach((function(e){e.addEventListener(\"click\",(function(e){E(e.target.getAttribute(\"data-num\"))}))})),document.onkeydown=function(e){let t=0;switch(e.key){case\"ArrowUp\":t=1;break;case\"ArrowRight\":t=2;break;case\"ArrowDown\":t=3;break;case\"ArrowLeft\":t=4}t&&(E(t),l(\"control\").children[t-1].classList.add(\"glow\"),setTimeout((function(){l(\"control\").children[t-1].classList.remove(\"glow\")}),200))},m.addEventListener(\"change\",e=>{M(m.value)},!1),l(\"rainbowMode\").addEventListener(\"click\",e=>{k(1-n)}),l(\"darkMode\").addEventListener(\"click\",e=>{b(1-a)}),u(\"wc_color\")&&(m.value=u(\"wc_color\"),M(m.value)),u(\"wc_rainbow\")&&k(parseInt(u(\"wc_rainbow\"))),u(\"wc_darkmode\")&&b(parseInt(u(\"wc_darkmode\"))),u(\"wc_speed\")&&(v.value=parseInt(u(\"wc_speed\"))),u(\"wc_score\")&&(r=u(\"wc_score\")),l(\"iphone\").href=l(\"icon\").href,window.location.href.includes(\"192.168.\")){l(\"searchBody\").classList.add(\"hide\");let e=new XMLHttpRequest;e.onreadystatechange=function(){if(4===this.readyState&&200===this.status){let n=JSON.parse(e.responseText);n.rainbow||(m.value=(t=n.red,s=n.green,a=n.blue,\"#\"+(1<<24|t<<16|s<<8|a).toString(16).slice(1))),M(m.value),b(n.darkmode),k(n.rainbow),v.value=n.speed}var t,s,a},e.open(\"GET\",\"get_params\",!0),e.send()}else l(\"snakeBody\").classList.add(\"hide\")}()</script></body></html>");
            }
