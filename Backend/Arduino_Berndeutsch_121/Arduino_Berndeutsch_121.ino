      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // Script
            client.println("<script>!function(){\"use strict\";let e,t,s,a=1,d=0,l=255,o=0,n=0;const c=document.getElementById(\"clock\"),i=document.getElementById(\"pageClock\"),r=document.getElementById(\"pageSettings\"),g=document.getElementById(\"color\");function m(e){document.styleSheets[0].cssRules[3].style.fill=e,document.styleSheets[0].cssRules[3].style.textShadow=\"0 0 10px \"+e,document.getElementsByTagName(\"a\")[0].style.color=e,document.getElementsByTagName(\"a\")[1].style.color=e}function u(e){e!==d&&(document.getElementById(\"rainbowMode\").children[0].classList.toggle(\"hide\"),document.getElementById(\"rainbowMode\").children[1].classList.toggle(\"hide\")),d=e,d||m(g.value)}function L(e){e!==a&&(document.getElementById(\"darkMode\").children[0].classList.toggle(\"hide\"),document.getElementById(\"darkMode\").children[1].classList.toggle(\"hide\")),a=e}setInterval((function(){e=new Date,d&&(l&&!n?(l-=1,o+=1):o?(o-=1,n+=1):(n-=1,l+=1),m(\"rgb(\"+l+\", \"+o+\", \"+n+\")\")),a&&(e.getHours()>=22||e.getHours()<7)?document.getElementsByTagName(\"body\")[0].classList.add(\"dark\"):document.getElementsByTagName(\"body\")[0].classList.remove(\"dark\"),s!==e.getMinutes()&&(s=e.getMinutes(),c.classList.remove(...c.classList),s>=55?c.classList.add(\"M5\",\"MV\"):s>=50?c.classList.add(\"M10\",\"MV\"):s>=45?c.classList.add(\"M15\",\"MV\"):s>=40?c.classList.add(\"M20\",\"MV\"):s>=35?c.classList.add(\"M5\",\"MA\",\"M30\"):s>=30?c.classList.add(\"M30\"):s>=25?c.classList.add(\"M5\",\"MV\",\"M30\"):s>=20?c.classList.add(\"M20\",\"MA\"):s>=15?c.classList.add(\"M15\",\"MA\"):s>=10?c.classList.add(\"M10\",\"MA\"):s>=5&&c.classList.add(\"M5\",\"MA\"),t=e.getHours(),s>=25&&(t+=1),t%=12,c.classList.add(\"H\"+t.toString()),c.classList.add(\"M\"+(s%5).toString()))}),100),document.getElementById(\"settings\").addEventListener(\"click\",(function(){document.activeElement.blur(),i.classList.remove(\"swipe-out-right\"),r.classList.remove(\"swipe-in-left\"),i.classList.add(\"swipe-out\"),r.classList.add(\"swipe-in\")})),document.getElementById(\"settingsClose\").addEventListener(\"click\",(function(){let e=parseInt(g.value.substring(1,3),16),t=parseInt(g.value.substring(3,5),16),s=parseInt(g.value.substring(5,7),16);i.classList.remove(\"swipe-out\"),r.classList.remove(\"swipe-in\"),i.classList.add(\"swipe-out-right\"),r.classList.add(\"swipe-in-left\"),localStorage.setItem(\"wc_color\",g.value),localStorage.setItem(\"wc_rainbow\",d),localStorage.setItem(\"wc_darkmode\",a),setTimeout((function(){window.location.search=\"&red=\"+e+\"&green=\"+t+\"&blue=\"+s+\"&rainbow=\"+d+\"&darkmode=\"+a}),500)})),document.getElementById(\"color\").addEventListener(\"change\",e=>{m(g.value)},!1),document.getElementById(\"rainbowMode\").addEventListener(\"click\",e=>{u(1-d)}),document.getElementById(\"darkMode\").addEventListener(\"click\",e=>{L(1-a)}),localStorage.getItem(\"wc_color\")&&(g.value=localStorage.getItem(\"wc_color\"),m(g.value)),localStorage.getItem(\"wc_rainbow\")&&u(parseInt(localStorage.getItem(\"wc_rainbow\"))),localStorage.getItem(\"wc_darkmode\")&&L(parseInt(localStorage.getItem(\"wc_darkmode\"))),document.getElementById(\"iphone\").href=document.getElementById(\"icon\").href}()</script></body></html>");
