        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            if (header.indexOf("snake") >= 0) {
              ...
              // Script
              client.println("<script>!function(){'use strict';let e,t,s,a=1,n=1,i=1,c=0,o=255,d=0,r=0,l=0,u=0,m='1',g=0,w=0,L=0;function p(e){return document.getElementById(e)}function f(e){return localStorage.getItem(e)}function h(e,t){return localStorage.setItem(e,t)}const v=p('clock'),M=p('pageClock'),y=p('pageSettings'),E=p('pageSnake'),b=p('color'),k=p('speed');function B(){c&&(o&&!r?(o-=1,d+=1):d?(d-=1,r+=1):(r-=1,o+=1),S('rgb('+o+', '+d+', '+r+')'),setTimeout(B,k.value/10))}function A(e){a=e,a?document.getElementsByTagName('body')[0].classList.remove('off'):document.getElementsByTagName('body')[0].classList.add('off'),s=-1}function S(e){document.documentElement.style.setProperty('--main-color',e)}function _(e){e!==c&&(p('rainbowMode').children[0].classList.toggle('hide'),p('rainbowMode').children[1].classList.toggle('hide')),c=e,c?B():S(b.value)}function N(e){e!==i&&(p('ghostMode').children[0].classList.toggle('hide'),p('ghostMode').children[1].classList.toggle('hide')),i=e}function T(e){e!==n&&(p('darkMode').children[0].classList.toggle('hide'),p('darkMode').children[1].classList.toggle('hide')),n=e}function I(){let e=parseInt(b.value.substring(1,3),16),t=parseInt(b.value.substring(3,5),16),s=parseInt(b.value.substring(5,7),16);if(h('wc_color',b.value),h('wc_rainbow',c),h('wc_darkmode',n),h('wc_ghost',i),h('wc_speed',k.value.toString()),window.location.href.includes('192.168.')||window.location.href.includes('.local')){let o=new XMLHttpRequest;o.open('GET','/update_params?red='+e+'&green='+t+'&blue='+s+'&rainbow='+c+'&darkmode='+n+'&speed='+k.value+'&power='+a+'&ghost='+i,!0),o.send()}}function x(e){let t=new XMLHttpRequest;t.onreadystatechange=function(){4===this.readyState&&200===this.status&&(l=10*(parseInt(t.responseText)-3),l>u&&(u=l,h('wc_score',u)),p('scoreSnake').innerHTML='Score: '+l+' / High-Score : '+u)},t.open('GET','snake?dir='+e,!0),t.send()}function C(e){let t='';if(1===e)t='mastermind?c4=0',H(),q();else if(2===e)t='mastermind?c4=7',H();else{if(console.log(document.querySelectorAll('[data-num=\\'1\\'], [data-num=\\'2\\'], [data-num=\\'3\\'], [data-num=\\'4\\'], [data-num=\\'5\\'], [data-num=\\'6\\']').length),document.querySelectorAll('[data-num=\\'1\\'], [data-num=\\'2\\'], [data-num=\\'3\\'], [data-num=\\'4\\'], [data-num=\\'5\\'], [data-num=\\'6\\']').length<14)return void q('Muesch zersch aues uswähle.');t='mastermind?c1='+document.getElementsByClassName('codeButton')[0].getAttribute('data-num')+'&c2='+document.getElementsByClassName('codeButton')[1].getAttribute('data-num')+'&c3='+document.getElementsByClassName('codeButton')[2].getAttribute('data-num')+'&c4='+document.getElementsByClassName('codeButton')[3].getAttribute('data-num'),H()}let s=new XMLHttpRequest;s.onreadystatechange=function(){if(4===this.readyState&&200===this.status){let e=JSON.parse(s.responseText);g=e.place,w=e.color,L=e.try,4===g?q('Bravo! I '+L+' Mau usegfunde.'):11===L?q('Schad, jetz hesch verlore.'):q()}},s.open('GET',t,!0),s.send()}function H(){Array.from(document.getElementsByClassName('codeButton')).forEach((function(e){e.setAttribute('data-num','')}))}function q(e){p('scoreMastermind').innerHTML=e||'<svg xmlns=\\'http://www.w3.org/2000/svg\\' class=\\'svgMsg\\' viewBox=\\'0 0 70 70\\'> <circle cx=\\'35\\' cy=\\'35\\' r=\\'25\\' fill=\\'white\\'/></svg>&nbsp;am richtige Ort&nbsp;<svg xmlns=\\'http://www.w3.org/2000/svg\\' class=\\'svgMsg\\' viewBox=\\'0 0 70 70\\'> <circle cx=\\'35\\' cy=\\'35\\' r=\\'25\\' fill=\\'cornflowerblue\\'/></svg>&nbsp;di richtigi Farb'}if(setInterval((function(){e=new Date,n&&(e.getHours()>=22||e.getHours()<7)?document.getElementsByTagName('body')[0].classList.add('dark'):document.getElementsByTagName('body')[0].classList.remove('dark'),s!==e.getMinutes()&&(s=e.getMinutes(),v.classList.remove(...v.classList),0!==a&&(s>=55?v.classList.add('M5','MV'):s>=50?v.classList.add('M10','MV'):s>=45?v.classList.add('M15','MV'):s>=40?v.classList.add('M20','MV'):s>=35?v.classList.add('M5','MA','M30'):s>=30?v.classList.add('M30'):s>=25?v.classList.add('M5','MV','M30'):s>=20?v.classList.add('M20','MA'):s>=15?v.classList.add('M15','MA'):s>=10?v.classList.add('M10','MA'):s>=5&&v.classList.add('M5','MA'),t=e.getHours(),s>=25&&(t+=1),t%=12,v.classList.add('H'+t.toString()),v.classList.add('M'+(s%5).toString())))}),100),p('power').addEventListener('click',(function(){A(1-a),I()})),p('settings').addEventListener('click',(function(){document.activeElement.blur(),M.classList.remove('swipe-out-right'),y.classList.remove('swipe-in-left'),M.classList.add('swipe-out'),y.classList.add('swipe-in')})),p('settingsClose').addEventListener('click',(function(){I(),M.classList.remove('swipe-out'),y.classList.remove('swipe-in'),y.classList.remove('swipe-out-right'),M.classList.add('swipe-out-right'),y.classList.add('swipe-in-left')})),p('playSnake').addEventListener('click',(function(){document.activeElement.blur(),y.classList.remove('swipe-out-right'),E.classList.remove('swipe-in-left'),y.classList.add('swipe-out'),E.classList.add('swipe-in'),x(5)})),p('exitSnake').addEventListener('click',(function(){y.classList.remove('swipe-out'),E.classList.remove('swipe-in'),y.classList.add('swipe-out-right'),E.classList.add('swipe-in-left'),x(6)})),p('playMastermind').addEventListener('click',(function(){document.activeElement.blur(),y.classList.remove('swipe-out-right'),pageMastermind.classList.remove('swipe-in-left'),y.classList.add('swipe-out'),pageMastermind.classList.add('swipe-in'),C(1)})),p('exitMastermind').addEventListener('click',(function(){y.classList.remove('swipe-out'),pageMastermind.classList.remove('swipe-in'),y.classList.add('swipe-out-right'),pageMastermind.classList.add('swipe-in-left'),C(2)})),p('sendMastermind').addEventListener('click',C),Array.from(document.getElementsByClassName('snakeButton')).forEach((function(e){e.addEventListener('click',(function(e){x(e.target.getAttribute('data-num'))}))})),Array.from(document.getElementsByClassName('colorButton')).forEach((function(e){e.addEventListener('click',(function(e){Array.from(document.getElementsByClassName('colorButton')).forEach((function(e){e.classList.remove('g')})),e.target.classList.add('g'),m=e.target.getAttribute('data-num')}))})),Array.from(document.getElementsByClassName('codeButton')).forEach((function(e){e.addEventListener('click',(function(e){e.target.setAttribute('data-num',m),q()}))})),document.onkeydown=function(e){let t=0;switch(e.key){case'ArrowUp':t=1;break;case'ArrowRight':t=2;break;case'ArrowDown':t=3;break;case'ArrowLeft':t=4}t&&(x(t),p('control').children[t-1].classList.add('g'),setTimeout((function(){p('control').children[t-1].classList.remove('g')}),200))},b.addEventListener('change',(e=>{S(b.value)}),!1),p('rainbowMode').addEventListener('click',(e=>{_(1-c)})),p('ghostMode').addEventListener('click',(e=>{N(1-i)})),p('darkMode').addEventListener('click',(e=>{T(1-n)})),f('wc_color')&&(b.value=f('wc_color'),S(b.value)),f('wc_rainbow')&&_(parseInt(f('wc_rainbow'))),f('wc_ghost')&&N(parseInt(f('wc_ghost'))),f('wc_darkmode')&&T(parseInt(f('wc_darkmode'))),f('wc_speed')&&(k.value=parseInt(f('wc_speed'))),f('wc_score')&&(u=f('wc_score')),p('iphone').href=p('icon').href,window.location.href.includes('192.168.')||window.location.href.includes('.local')){let e=new XMLHttpRequest;e.onreadystatechange=function(){if(4===this.readyState&&200===this.status){let n=JSON.parse(e.responseText);n.rainbow||(b.value=(t=n.red,s=n.green,a=n.blue,'#'+(1<<24|t<<16|s<<8|a).toString(16).slice(1))),S(b.value),T(n.darkmode),_(n.rainbow),N(n.ghost),A(n.power),k.value=n.speed}var t,s,a},e.open('GET','get_params',!0),e.send()}else p('snakeBody').classList.add('hide'),p('mastermindBody').classList.add('hide')}();</script></body></html>");
            }
