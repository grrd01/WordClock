        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            if (header.indexOf("snake") >= 0) {
              ...
              // Script
              client.println("<script>onload=function(){!function(){\"use strict\";let e,t,s,n=1,a=1,i=0,c=255,o=0,r=0,d=0,l=0,u=\"1\",m=0,g=0;function w(e){return document.getElementById(e)}function p(e){return localStorage.getItem(e)}function L(e,t){return localStorage.setItem(e,t)}const f=w(\"clock\"),v=w(\"pageClock\"),h=w(\"pageSettings\"),M=w(\"pageSnake\"),E=w(\"color\"),y=w(\"speed\");function b(){i&&(c&&!r?(c-=1,o+=1):o?(o-=1,r+=1):(r-=1,c+=1),B(\"rgb(\"+c+\", \"+o+\", \"+r+\")\"),setTimeout(b,y.value/10))}function k(e){n=e,n?document.getElementsByTagName(\"body\")[0].classList.remove(\"off\"):document.getElementsByTagName(\"body\")[0].classList.add(\"off\"),s=-1}function B(e){document.documentElement.style.setProperty(\"--main-color\",e)}function A(e){e!==i&&(w(\"rainbowMode\").children[0].classList.toggle(\"hide\"),w(\"rainbowMode\").children[1].classList.toggle(\"hide\")),i=e,i?b():B(E.value)}function S(e){e!==a&&(w(\"darkMode\").children[0].classList.toggle(\"hide\"),w(\"darkMode\").children[1].classList.toggle(\"hide\")),a=e}function _(){let e=parseInt(E.value.substring(1,3),16),t=parseInt(E.value.substring(3,5),16),s=parseInt(E.value.substring(5,7),16);if(L(\"wc_color\",E.value),L(\"wc_rainbow\",i),L(\"wc_darkmode\",a),L(\"wc_speed\",y.value.toString()),window.location.href.includes(\"192.168.\")||window.location.href.includes(\".local\")){let c=new XMLHttpRequest;c.open(\"GET\",\"/update_params?red=\"+e+\"&green=\"+t+\"&blue=\"+s+\"&rainbow=\"+i+\"&darkmode=\"+a+\"&speed=\"+y.value+\"&power=\"+n,!0),c.send()}}function T(e){let t=new XMLHttpRequest;t.onreadystatechange=function(){4===this.readyState&&200===this.status&&(d=10*(parseInt(t.responseText)-3),d>l&&(l=d,L(\"wc_score\",l)),w(\"scoreSnake\").innerHTML=\"Score: \"+d+\" / High-Score : \"+l)},t.open(\"GET\",\"snake?dir=\"+e,!0),t.send()}function N(e){let t=\"\";if(1===e)t=\"mastermind?c4=0\",I(),x();else if(2===e)t=\"mastermind?c4=7\",I();else{if(console.log(document.querySelectorAll(\"[data-num='1'], [data-num='2'], [data-num='3'], [data-num='4'], [data-num='5'], [data-num='6']\").length),document.querySelectorAll(\"[data-num='1'], [data-num='2'], [data-num='3'], [data-num='4'], [data-num='5'], [data-num='6']\").length<14)return void x(\"Muesch zersch aues uswähle.\");t=\"mastermind?c1=\"+document.getElementsByClassName(\"codeButton\")[0].getAttribute(\"data-num\")+\"&c2=\"+document.getElementsByClassName(\"codeButton\")[1].getAttribute(\"data-num\")+\"&c3=\"+document.getElementsByClassName(\"codeButton\")[2].getAttribute(\"data-num\")+\"&c4=\"+document.getElementsByClassName(\"codeButton\")[3].getAttribute(\"data-num\"),I()}let s=new XMLHttpRequest;s.onreadystatechange=function(){4===this.readyState&&200===this.status&&(m=parseInt(s.responseText),g=parseInt(s.responseText),x())},s.open(\"GET\",t,!0),s.send()}function I(){Array.from(document.getElementsByClassName(\"codeButton\")).forEach((function(e){e.setAttribute(\"data-num\",\"\")}))}function x(e){w(\"scoreMastermind\").innerHTML=e||\"<svg xmlns='http://www.w3.org/2000/svg' class='svgMsg' viewBox='0 0 70 70'> <circle cx='35' cy='35' r='25' fill='white'/></svg>&nbsp;am richtige Ort&nbsp;<svg xmlns='http://www.w3.org/2000/svg' class='svgMsg' viewBox='0 0 70 70'> <circle cx='35' cy='35' r='25' fill='grey'/></svg>&nbsp;di richtigi Farb\"}if(setInterval((function(){e=new Date,a&&(e.getHours()>=22||e.getHours()<7)?document.getElementsByTagName(\"body\")[0].classList.add(\"dark\"):document.getElementsByTagName(\"body\")[0].classList.remove(\"dark\"),s!==e.getMinutes()&&(s=e.getMinutes(),f.classList.remove(...f.classList),0!==n&&(s>=55?f.classList.add(\"M5\",\"MV\"):s>=50?f.classList.add(\"M10\",\"MV\"):s>=45?f.classList.add(\"M15\",\"MV\"):s>=40?f.classList.add(\"M20\",\"MV\"):s>=35?f.classList.add(\"M5\",\"MA\",\"M30\"):s>=30?f.classList.add(\"M30\"):s>=25?f.classList.add(\"M5\",\"MV\",\"M30\"):s>=20?f.classList.add(\"M20\",\"MA\"):s>=15?f.classList.add(\"M15\",\"MA\"):s>=10?f.classList.add(\"M10\",\"MA\"):s>=5&&f.classList.add(\"M5\",\"MA\"),t=e.getHours(),s>=25&&(t+=1),t%=12,f.classList.add(\"H\"+t.toString()),f.classList.add(\"M\"+(s%5).toString())))}),100),w(\"power\").addEventListener(\"click\",(function(){k(1-n),_()})),w(\"settings\").addEventListener(\"click\",(function(){document.activeElement.blur(),v.classList.remove(\"swipe-out-right\"),h.classList.remove(\"swipe-in-left\"),v.classList.add(\"swipe-out\"),h.classList.add(\"swipe-in\")})),w(\"settingsClose\").addEventListener(\"click\",(function(){_(),v.classList.remove(\"swipe-out\"),h.classList.remove(\"swipe-in\"),h.classList.remove(\"swipe-out-right\"),v.classList.add(\"swipe-out-right\"),h.classList.add(\"swipe-in-left\")})),w(\"playSnake\").addEventListener(\"click\",(function(){document.activeElement.blur(),h.classList.remove(\"swipe-out-right\"),M.classList.remove(\"swipe-in-left\"),h.classList.add(\"swipe-out\"),M.classList.add(\"swipe-in\"),T(5)})),w(\"exitSnake\").addEventListener(\"click\",(function(){h.classList.remove(\"swipe-out\"),M.classList.remove(\"swipe-in\"),h.classList.add(\"swipe-out-right\"),M.classList.add(\"swipe-in-left\"),T(6)})),w(\"playMastermind\").addEventListener(\"click\",(function(){document.activeElement.blur(),h.classList.remove(\"swipe-out-right\"),pageMastermind.classList.remove(\"swipe-in-left\"),h.classList.add(\"swipe-out\"),pageMastermind.classList.add(\"swipe-in\"),N(1)})),w(\"exitMastermind\").addEventListener(\"click\",(function(){h.classList.remove(\"swipe-out\"),pageMastermind.classList.remove(\"swipe-in\"),h.classList.add(\"swipe-out-right\"),pageMastermind.classList.add(\"swipe-in-left\"),N(2)})),w(\"sendMastermind\").addEventListener(\"click\",N),Array.from(document.getElementsByClassName(\"snakeButton\")).forEach((function(e){e.addEventListener(\"click\",(function(e){T(e.target.getAttribute(\"data-num\"))}))})),Array.from(document.getElementsByClassName(\"colorButton\")).forEach((function(e){e.addEventListener(\"click\",(function(e){Array.from(document.getElementsByClassName(\"colorButton\")).forEach((function(e){e.classList.remove(\"g\")})),e.target.classList.add(\"g\"),u=e.target.getAttribute(\"data-num\")}))})),Array.from(document.getElementsByClassName(\"codeButton\")).forEach((function(e){e.addEventListener(\"click\",(function(e){e.target.setAttribute(\"data-num\",u),x()}))})),document.onkeydown=function(e){let t=0;switch(e.key){case\"ArrowUp\":t=1;break;case\"ArrowRight\":t=2;break;case\"ArrowDown\":t=3;break;case\"ArrowLeft\":t=4}t&&(T(t),w(\"control\").children[t-1].classList.add(\"g\"),setTimeout((function(){w(\"control\").children[t-1].classList.remove(\"g\")}),200))},E.addEventListener(\"change\",e=>{B(E.value)},!1),w(\"rainbowMode\").addEventListener(\"click\",e=>{A(1-i)}),w(\"darkMode\").addEventListener(\"click\",e=>{S(1-a)}),p(\"wc_color\")&&(E.value=p(\"wc_color\"),B(E.value)),p(\"wc_rainbow\")&&A(parseInt(p(\"wc_rainbow\"))),p(\"wc_darkmode\")&&S(parseInt(p(\"wc_darkmode\"))),p(\"wc_speed\")&&(y.value=parseInt(p(\"wc_speed\"))),p(\"wc_score\")&&(l=p(\"wc_score\")),w(\"iphone\").href=w(\"icon\").href,window.location.href.includes(\"192.168.\")||window.location.href.includes(\".local\")){let e=new XMLHttpRequest;e.onreadystatechange=function(){if(4===this.readyState&&200===this.status){let a=JSON.parse(e.responseText);a.rainbow||(E.value=(t=a.red,s=a.green,n=a.blue,\"#\"+(1<<24|t<<16|s<<8|n).toString(16).slice(1))),B(E.value),S(a.darkmode),A(a.rainbow),k(a.power),y.value=a.speed}var t,s,n},e.open(\"GET\",\"get_params\",!0),e.send()}}()}</script> </body> </html>");
            }
