...
const char wordGuessrWords0[] PROGMEM = "AARE ABEND ABENTEUER ACHSE ACHT ACKER ADER ADRIA AFRIKA AGENT AKTION AMEISE AMERIKA AMOR AMT ANANAS ANFANG ANGEBOT ANGST ANTWORT ANZUG ARBEIT ARCHIV ARGENTINIEN ÄRGER ARM ARMBAND ARZT ASTRONAUT ATHEN ATMEN AUGE AUGUST AUSDAUER AUSGANG AUTO AUTOBAHN AVOCADO BACH BACKE BADEN BADEWANNE BAHN BANANE BAND BANK BÄR BART BATTERIE BAUCH BAUER BAUM BECHER BEDINGUNG BEERE BEGINN BEIN BEITRAG BEKANNTSCHAFT BERATUNG BERG BERICHT BERN BERUF BESCHWERDE BESUCH BETON BETRAG BETT BEWEIS BEWERTUNG BIBER BIENE BIER BIRNE BISON BODEN BOGEN BOHNE BOMBE BRAUE BRAUN BREI BREIT BRIEF BRONZE BROT BRÜCKE BRUST BUCH BUCHE BUCHSTABE BÜHNE BUND BURG BÜRSTE BUSCH BUTTER CHINA DACH";
const char wordGuessrWords1[] PROGMEM = "DACHS DAME DÄNEMARK DANK DARM DAUER DAUMEN DECKE DETEKTIV DICK DIEB DIENST DING DOKTOR DOKUMENT DOMINO DONAU DONNER DOOF DORF DRACHE DRAMA DREI DREIECK DREIRAD DROMEDAR DÜNN DUNST EBBE EBENE ECHSE ECKE EHE EI EICHE EIDECHSE EIER EIGENSCHAFT EINKAUF EINS EIS EISBÄR EISHOCKEY ENDE ENERGIE ENTE ERBSE ERDE ERFINDUNG ERINNERUNG ERWARTUNG ESCHE ESSEN ESTRICH EWIGKEIT EXTREM FADEN FAHRRAD FANTASIE FARBE FASS FEBRUAR FEE FEIGE FENSTER FERNSEHER FEST FESTUNG FEUER FEUERWEHR FINGER FINK FIRMA FISCH FISCHER FONDUE FORM FORMAT FOTOGRAFIE FRAGE FRAU FREIHEIT FREITAG FREUDE FREUND FRIEDEN FRISUR FROSCH FROST FRUCHT FRÜHSTÜCK FUCHS FÜNF FUNKTION FUSS GANG GANS GARTEN GAS GASSE";
const char wordGuessrWords2[] PROGMEM = "GAST GEBÄUDE GEBIET GEBISS GEBURT GEDANKE GEDICHT GEFAHR GEFÄNGNIS GEGENSTAND GEHEIMNIS GEHEN GEHIRN GEIER GEIST GEMÜSE GENF GERICHT GESANG GESCHÄFT GESCHICHTE GESCHMACK GESICHT GETREIDE GEWICHT GEWINN GIRAFFE GOTT GRABEN GRAD GRAS GRENZE GROSS GRUBE GRÜN GRUND GUT HAAR HAHN HAI HAMSTER HAND HASE HASS HAUS HAUT HECHT HEFT HEIMAT HEISS HERBST HERDE HERZ HIMBEERE HINTEN HINWEIS HIRSCH HIRT HITZE HOBBY HOCH HOCHHAUS HOCHZEIT HOFFNUNG HONIG HOSE HÜFTE HUHN HUND HUNDERT HUT HÜTTE HYÄNE INDIANER INDIEN INFORMATION INTERESSE INTERNET IRAK IRAN KÄFER KAFFEE KAIRO KAISER KAKAO KAMERA KAMIN KANADA KÄNGURU KANTON KANU KAROTTE KARTE KÄSE KASSE KATZE KAUF KENIA KERN KERZE";
const char wordGuessrWords3[] PROGMEM = "KETTE KIEFER KIES KIND KINO KIRCHE KIRSCHE KISSEN KIWI KNAST KNIE KNOCHEN KOBRA KOFFER KOMET KONFITÜRE KONGO KÖNIG KONSTANT KONTAKT KONZERT KOREA KOSTEN KRAFT KRAFTWERK KRAKE KRANICH KRATER KREIS KREUZ KRIEG KRIMI KRISE KRITIK KRÖTE KÜCHE KUH KÜKEN KUNDE KUNST KÜRBIS KURS KUSS MÄDCHEN MADRID MAGEN MAI MAIS MANDARINE MANGO MANN MARKE MARKT MARS MÄRZ MASCHINE MATRATZE MAUER MAUS MEER MEINUNG MEISE MEISTER MENGE MENSCH MESSER MESSING METER METRO MEXIKO MINUTE MITTAG MITTE MODE MONAT MOND MONITOR MÖRDER MORGEN MÖVE MUND MÜNSTER MÜNZE MUSIK MUT MUTTER MÜTZE NACHT NAH NÄHE NAME NARBE NASE NASHORN NASS NATUR NETZ NEUN NIERE NIGERIA";
const char wordGuessrWords4[] PROGMEM = "NORDEN NORWEGEN NOVEMBER NUSS OBST OCHSE OHR OHRRING OKTOBER OMA ORANGE ORDNER OSTEN QUITTE RABE RAD RADIO RADIUS RAKETE RASEN RATTE RÄUBER RECHT REDEN REGEN REGION REH REICH REIM REIS REISE RENNEN RENTIER REST RICHTER RICHTIG RITTER ROBBE ROBOTER ROCHEN ROM ROMAN ROSA ROT RUANDA RÜCKEN RUHE RÜHREI RUNDE SACHE SAFT SAMSTAG SAND SATURN SATZ SCHACH SCHAF SCHATTEN SCHIFF SCHMUCK SCHNAUZ SCHNECKE SCHNEE SCHNEIDER SCHÖN SCHRANK SCHRAUBE SCHRIFT SCHRITT SCHROTT SCHUH SCHUTZ SCHWAN SCHWEIN SCHWEIZ SCHWERT SECHS SEE SEHNE SEITE SEKUNDE SEMESTER SENDUNG SENSATION SICHT SIEBEN SIEG SKI SOCKE SOFA SOHN SONNE SORGE STAAT STADT STAND STAR START STECKER STEHEN";
const char wordGuessrWords5[] PROGMEM = "STEIN STEINBOCK STERN STIER STIFT STIRN STOFF STORCH STRAND STRASSE STRAUSS STROH STROM STÜCK STUDIE STUNDE STURM SÜDEN SYRIEN SZENE TAG TANDEM TANKER TANNE TANSANIA TANTE TANZ TASTATUR TÄTER TAUCHER TAUSEND TEE TEENAGER TEER TEICH TENNIS TERMIN TESSIN TEST TEUER TEXT THEATER THRON TIEF TIER TIGER TINTE TISCH TOCHTER TOD TOKYO TOMATE TOURIST TRAKTOR TRAM TRANK TRAUBE TRAUER TRAUM TRICK TRINKEN TROCKEN TROTTOIR TRUTHAHN TUCH TÜR TÜRKEI UGANDA UHR UHU UKRAINE UMFANG UNGARN UNIVERSUM UNKRAUT URI URIN URSACHE VATER VENE VENEDIG VENUS VERBAND VEREIN VERSE VERTRAG VIDEO VIER VIETNAM VORHANG VORNE WADE WAGEN WAND WANDERUNG WARM WÄRME WASSER WEG WEIHNACHT";
const char wordGuessrWords6[] PROGMEM = "WEIN WEIT WEIZEN WERBUNG WERK WERKZEUG WERT WESTEN WETTER WIEN WIND WINTER WIRKUNG WITZ WITZIG WOCHE WORT WUNDE WUNDER WUNSCH WURM WURST ZANGE ZAUN ZEBRA ZEH ZEHN ZEICHEN ZEICHNUNG ZEIT ZEITUNG ZEMENT ZIEGE ZINS ZITRONE ZUCKER ZUG ZUKUNFT ZUNGE ZÜRICH ZUSTAND ZWECK ZWEI";

const char* const wordGuessrWordsAll[] PROGMEM = {wordGuessrWords0, wordGuessrWords1, wordGuessrWords2, wordGuessrWords3, wordGuessrWords4, wordGuessrWords5, wordGuessrWords6};
...
void wordGuessrNewGuess() {
  ...
  int listNr = random(6); // Index to randomly load one of ten wordlists from progmem
