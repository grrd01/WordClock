...
// Progmem: https://www.arduino.cc/reference/de/language/variables/utilities/progmem/ https://arduino-esp8266.readthedocs.io/en/latest/PROGMEM.html
...
void loop() {
  ...
  if (inSnake) {
    ...
    if (millis() > wordGuessrStart + (wordGuessrHint + 1) * 30000) {
