...
// ToDo: WordGuessr: Strings in PROGMEM speichern: https://www.arduino.cc/reference/de/language/variables/utilities/progmem/ https://arduino-esp8266.readthedocs.io/en/latest/PROGMEM.html https://forum.arduino.cc/t/gelost-esp8266-progmem-string-array-will-nicht/621976/5
...
const char* version = "maschawordclock";
...
// "AARE","ABENTEUER","ABSCHLUSS","ADER","AGENT","ÄGYPTEN","ALPEN","ALPHABET","AMEISE","AMERIKA","AMOR","ANANAS","ANGEBOT","ANLAGE","ANTILOPE","ANTWORT","ANZUG","APFEL","APRIL","ARBEIT","ARGENTINIEN","ARM","ARMBAND","ARTIKEL","ATHEN","AUGE","AUGUST","AUSDAUER","AUSGANG","AUSWAHL","AUTO","AUTOBAHN","BACH","BADEWANNE","BAND","BÄR","BART","BATTERIE","BAUCH","BAUM","BECHER","BEDINGUNG","BEERE","BEGINN","BEIN","BEISPIEL","BEKANNTSCHAFT","BERATUNG","BERG","BERICHT","BERN","BERUF","BESCHWERDE","BETRAG","BETT","BEWERTUNG","BIBLIOTHEK","BIENE","BIER","BILD","BILLARD","BIRNE","BLICK","BLUME","BLUT","BOGEN","BOMBE","BRIEF","BRILLE","BROKKOLI","BROT","BUCH","BUCHSTABE","BÜRSTE","BUSCH","BUTTER","CHINA","COMPUTER","DAME","DARM","DAUER","DECKE","DELFIN","DETEKTIV","DIALOG","DIEB","DIENST","DING","DISTEL","DOKUMENT","DOMINO","DRACHE","DRAMA","DROSSEL","EBBE","EBENE","ECKE","EIER","EIGENSCHAFT","EINFLUSS","EINKAUF","EINSTELLUNG","EINTOPF","EIS","EISHOCKEY","ELCH","ELLBOGEN","ENERGIE","ENTE","ENTWICKLUNG","ERDE","ERFINDUNG","ERINNERUNG","ERKLÄRUNG","ERLEBNIS","ERWARTUNG","ESEL","ESTRICH","EWIGKEIT","FAHRPLAN","FAHRRAD","FAMILIE","FANTASIE","FARBE","FEBRUAR","FEE","FEHLER","FELDSTECHER","FELS","FENSTER","FERNSEHER","FEST","FESTIVAL","FEUERWEHR","FILM","FINGER","FINK","FISCH","FLEISCH","FLIEGE","FLOH","FLUGZEUG","FLUSS","FLUT","FONDUE","FORELLE","FOTOGRAFIE","FRAU","FREIHEIT","FREUND","FRISUR","FROSCH","FROST","FRUCHT","FRÜHLING","FRÜHSTÜCK","FUCHS","FUNKTION","FUSS","FUSSBALL","GABEL","GANG","GANS","GARTEN","GASSE","GEBÄUDE","GEBISS","GEBURT","GEDANKE","GEFAHR","GEFÄNGNIS","GEFÜHL","GEGENSTAND","GEHEIMNIS","GEIST","GELD","GELENK","GEMÄLDE","GEMÜSE","GENF","GEOGRAPHIE","GESANG","GESCHÄFT","GESCHICHTE","GESCHMACK","GESICHT","GESPENST","GETREIDE","GEWICHT","GEWINN","GIPFEL","GIRAFFE","GLAS","GLEIS","GLOCKE","GLÜCK","GOLF","GOTT","GRABEN","GRAS","GRENZE","GRILL","GRUND","HAAR","HAHN","HALS","HAMMER","HAMSTER","HAND","HASS","HAUS","HAUT","HECHT","HEFT","HEIMAT","HELSINKI","HERBST","HERDE","HERZ","HIMBEERE","HINWEIS","HIRSCH","HIRT","HITZE","HOBBY","KAIRO","HOCHHAUS","HOCHZEIT","HOFFNUNG","HONIG","HOSE","HOTEL","HÜGEL","HUHN","HUND","HUT","HÜTTE","HYÄNE","IGEL","IMMER","INDIEN","INFORMATION","INHALT","INTERESSE","ITALIEN","KABEL","KALB","KÄLTE","KAMEL","KAMERA","KAMM","KANADA","KANTON","KAROTTE","KARTOFFEL","KATZE","KELLE","KELLER","KERZE","KIES","KIND","KINO","KIRCHE","KIRSCHE","KISSEN","KIWI","KLEID","KLEIDER","KLIMA","KNAST","KNIE","KNOSPE","KOFFER","KOLLEGE","KOMMA","KOMMODE","KOMMUNIKATION","KONFITÜRE","KÖRPER","KRAFTWERK","KRAKE","KRANICH","KREIS","KREUZ","KRIEG","KRIMI","KRÖTE","KÜCHE","KUH","KÜKEN","KÜNSTLER","LAMM","LAND","LANDKARTE","LAUB","LEBEN","LEITER","LIEBE","LÖFFEL","LONDON","LÖWE","LUCHS","LUNGE","MADRID","MAGEN","MAI","MAIS","MANDARINE","MANN","MÄRZ","MASCHINE","MATRATZE","MAUS","MEER","MEISE","MEISSEL","MELODIE","MENGE","MESSER","METRO","MILCH","MINUTE","MODE","MOMENT","MONAT","MOND","MONITOR","MÖRDER","MÖVE","MUMIE","MÜNSTER","MÜNZE","MUSIK","MUSKEL","MÜTZE","NARBE","NASE","NATUR","NEBEL","NOVEMBER","NUDELN","NUSS","OBST","OHR","OHRRING","OKTOBER","OLYMPIA","OMELETTE","OPER","ORANGE","ORDNER","OSLO","PALME","PANDABÄR","PARIS","PARTY","PELIKAN","PERSON","PERU","PFANNE","PFEFFER","PFEIL","PFLANZE","PFLASTER","PHARAO","PINSEL","PLANET","POLIZIST","PRAG","PYRAMIDE","RABE","RACLETTE","RADIO","RAKETE","RÄTSEL","RÄUBER","RAUPE","RAVIOLI","REGEN","REH","REIS","ROBOTER","ROM","ROMAN","RUANDA","RÜCKEN","RÜHREI","SAFT","SALAT","SALZ","SCHACH","SCHÄDEL","SCHAF","SCHATTEN","SCHAUFEL","SCHLAMM","SCHLANGE","SCHMUCK","SCHNAUZ","SCHNECKE","SCHNEE","SCHNEIDER","SCHRANK","SCHUH","SCHULTER","SCHWAN","SCHWEIN","SCHWEIZ","SEE","SEHNE","SEIL","SEKUNDE","SENSATION","SILBE","SILVESTER","SIRUP","SKELETT","SOCKE","SOFA","SOMMER","SONNE","SPATZ","SPECHT","SPIEL","SPION","SPORT","STADT","STAR","STECKER","STEIN","STEINBOCK","STIEFEL","STIER","STIFT","STIRN","STOFF","STORCH","STRAND","STRASSE","STRAUSS","STROM","STUHL","STUNDE","STURM","SUMPF","SUPERMARKT","TAG","TAL","TANDEM","TANKER","TANNE","TANZ","TASTATUR","TEENAGER","TEICH","TELLER","TENNIS","TESSIN","THEATER","THRILLER","TIER","TIGER","TINTE","TISCH","TOD","TOKYO","TRAM","TRAUBE","TRAUER","TROTTOIR","TRUTHAHN","TUCH","TULPE","UGANDA","UNIVERSUM","UNKRAUT","URI","URLAUB","VANILLE","VEILCHEN","VELO","VENE","VENEDIG","VERBAND","VIDEO","VORHANG","WAL","WANDERUNG","WÄRME","WASSER","WEG","WEIHNACHT","WEIN","WERKZEUG","WESPE","WIEN","WIND","WINTER","WOCHE","WOLF","WOLKE","WORT","WUNDE","WURM","WURST","ZANGE","ZEBRA","ZEH","ZEICHEN","ZEICHNUNG","ZEITUNG","ZIEGE","ZOPF","ZUCKER","ZUG","ZYLINDER","MUSCHEL"
const String wordGuessrWords[] = {"AARE","ABENTEUER","ABSCHLUSS","ADER","AGENT","ÄGYPTEN","ALPEN","ALPHABET","AMEISE","AMERIKA","AMOR","ANANAS","ANGEBOT","ANLAGE","ANTILOPE","ANTWORT","ANZUG","APFEL","APRIL","ARBEIT","ARGENTINIEN","ARM","ARMBAND","ARTIKEL","ATHEN","AUGE","AUGUST","AUSDAUER","AUSGANG","AUSWAHL","AUTO","AUTOBAHN","BACH","BADEWANNE","BAND","BÄR","BART","BATTERIE","BAUCH","BAUM","BECHER","BEDINGUNG","BEERE","BEGINN","BEIN","BEISPIEL","BEKANNTSCHAFT","BERATUNG","BERG","BERICHT","BERN","BERUF","BESCHWERDE","BETRAG","BETT","BEWERTUNG","BIBLIOTHEK","BIENE","BIER","BILD","BILLARD","BIRNE","BLICK","BLUME","BLUT","BOGEN","BOMBE","BRIEF","BRILLE","BROKKOLI","BROT","BUCH","BUCHSTABE","BÜRSTE","BUSCH","BUTTER","CHINA","COMPUTER","DAME","DARM","DAUER","DECKE","DELFIN","DETEKTIV","DIALOG","DIEB","DIENST","DING","DISTEL","DOKUMENT","DOMINO","DRACHE","DRAMA","DROSSEL","EBBE","EBENE","ECKE","EIER","EIGENSCHAFT","EINFLUSS","EINKAUF","EINSTELLUNG","EINTOPF","EIS","EISHOCKEY","ELCH","ELLBOGEN","ENERGIE","ENTE","ENTWICKLUNG","ERDE","ERFINDUNG","ERINNERUNG","ERKLÄRUNG","ERLEBNIS","ERWARTUNG","ESEL","ESTRICH","EWIGKEIT","FAHRPLAN","FAHRRAD","FAMILIE","FANTASIE","FARBE","FEBRUAR","FEE","FEHLER","FELDSTECHER","FELS","FENSTER","FERNSEHER","FEST","FESTIVAL","FEUERWEHR","FILM","FINGER","FINK","FISCH","FLEISCH","FLIEGE","FLOH","FLUGZEUG","FLUSS","FLUT","FONDUE","FORELLE","FOTOGRAFIE","FRAU","FREIHEIT","FREUND","FRISUR","FROSCH","FROST","FRUCHT","FRÜHLING","FRÜHSTÜCK","FUCHS","FUNKTION","FUSS","FUSSBALL","GABEL","GANG","GANS","GARTEN","GASSE","GEBÄUDE","GEBISS","GEBURT","GEDANKE","GEFAHR","GEFÄNGNIS","GEFÜHL","GEGENSTAND","GEHEIMNIS","GEIST","GELD","GELENK","GEMÄLDE","GEMÜSE","GENF","GEOGRAPHIE","GESANG","GESCHÄFT","GESCHICHTE","GESCHMACK","GESICHT","GESPENST","GETREIDE","GEWICHT","GEWINN","GIPFEL","GIRAFFE","GLAS","GLEIS","GLOCKE","GLÜCK","GOLF","GOTT","GRABEN","GRAS","GRENZE","GRILL","GRUND","HAAR","HAHN","HALS","HAMMER","HAMSTER","HAND","HASS","HAUS","HAUT","HECHT","HEFT","HEIMAT","HELSINKI","HERBST","HERDE","HERZ","HIMBEERE","HINWEIS","HIRSCH","HIRT","HITZE","HOBBY","KAIRO","HOCHHAUS","HOCHZEIT","HOFFNUNG","HONIG","HOSE","HOTEL","HÜGEL","HUHN","HUND","HUT","HÜTTE","HYÄNE","IGEL","IMMER","INDIEN","INFORMATION","INHALT","INTERESSE","ITALIEN","KABEL","KALB","KÄLTE","KAMEL","KAMERA","KAMM","KANADA","KANTON","KAROTTE","KARTOFFEL","KATZE","KELLE","KELLER","KERZE","KIES","KIND","KINO","KIRCHE","KIRSCHE","KISSEN","KIWI","KLEID","KLEIDER","KLIMA","KNAST","KNIE","KNOSPE","KOFFER","KOLLEGE","KOMMA"};
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            if (header.indexOf("snake") >= 0) {
              ...
              // Script
              client.println("<script>!function(){'use strict';let e,t,s,n=1,a=1,i=1,r=0,c=255,o=0,d=0,l=0,u=0,g='1',w=0,m=0,f=0;function L(e){return document.getElementById(e)}function h(e){return localStorage.getItem(e)}function p(e,t){return localStorage.setItem(e,t)}const v=L('clock'),M=L('pageClock'),b=L('pageSettings'),k=L('pageSnake'),E=L('pageMastermind'),y=L('pageWordGuessr'),A=L('color'),S=L('speed'),_=L('wordInput'),T=L('rainbowMode'),x=L('ghostMode'),H=L('darkMode'),B=document.getElementsByTagName('body')[0],C=document.getElementsByClassName('codeButton'),I=document.getElementsByClassName('colorButton');function G(){r&&(c&&!d?(c-=1,o+=1):o?(o-=1,d+=1):(d-=1,c+=1),W('rgb('+c+', '+o+', '+d+')'),setTimeout(G,S.value/10))}function N(e){n=e,n?B.classList.remove('off'):B.classList.add('off'),s=-1}function q(e,t){document.activeElement.blur(),e.classList.remove('swipe-out-right'),t.classList.remove('swipe-in-left'),e.classList.add('swipe-out'),t.classList.add('swipe-in')}function R(e,t){e.classList.remove('swipe-out'),t.classList.remove('swipe-in'),e.classList.add('swipe-out-right'),t.classList.add('swipe-in-left')}function W(e){document.documentElement.style.setProperty('--main-color',e)}function O(e){e!==r&&(T.children[0].classList.toggle('hide'),T.children[1].classList.toggle('hide')),r=e,r?G():W(A.value)}function D(e){e!==i&&(x.children[0].classList.toggle('hide'),x.children[1].classList.toggle('hide')),i=e}function V(e){e!==a&&(H.children[0].classList.toggle('hide'),H.children[1].classList.toggle('hide')),a=e}function X(){let e=parseInt(A.value.substring(1,3),16),t=parseInt(A.value.substring(3,5),16),s=parseInt(A.value.substring(5,7),16);if(p('wc_color',A.value),p('wc_rainbow',r),p('wc_dark',a),p('wc_ghost',i),p('wc_speed',S.value.toString()),window.location.href.includes('192.168.')||window.location.href.includes('.local')){let c=new XMLHttpRequest;c.open('GET','/update_params?red='+e+'&green='+t+'&blue='+s+'&rainbow='+r+'&darkmode='+a+'&speed='+S.value+'&power='+n+'&ghost='+i,!0),c.send()}}function J(e){let t=new XMLHttpRequest;t.onreadystatechange=function(){4===this.readyState&&200===this.status&&(l=10*(parseInt(t.responseText)-3),l>u&&(u=l,p('wc_score',u)),L('scoreSnake').innerHTML='Score: '+l+' / High-Score : '+u)},t.open('GET','snake?dir='+e,!0),t.send()}function U(e){let t='';if(1===e)t='mastermind?c4=0',z(),K();else if(2===e)t='mastermind?c4=7',z();else{if(document.querySelectorAll('[data-num=\"1\"], [data-num=\"2\"], [data-num=\"3\"], [data-num=\"4\"], [data-num=\"5\"], [data-num=\"6\"]').length<14)return void K('Muesch zersch aues uswähle.');t='mastermind?c1='+C[0].getAttribute('data-num')+'&c2='+C[1].getAttribute('data-num')+'&c3='+C[2].getAttribute('data-num')+'&c4='+C[3].getAttribute('data-num'),z()}let s=new XMLHttpRequest;s.onreadystatechange=function(){if(4===this.readyState&&200===this.status){let e=JSON.parse(s.responseText);w=e.place,m=e.try,4===w?K('Bravo! I '+m+' Mau usegfunde.'):11===m?K('Schad, jetz hesch verlore.'):K()}},s.open('GET',t,!0),s.send()}function z(){Array.from(C).forEach((function(e){e.setAttribute('data-num','')}))}function K(e){L('scoreMastermind').innerHTML=e||'<svg xmlns=\"http://www.w3.org/2000/svg\" class=\"svgMsg\" viewBox=\"0 0 70 70\"> <circle cx=\"35\" cy=\"35\" r=\"25\" fill=\"white\"/></svg>&nbsp;am richtige Ort&nbsp;<svg xmlns=\"http://www.w3.org/2000/svg\" class=\"svgMsg\" viewBox=\"0 0 70 70\"> <circle cx=\"35\" cy=\"35\" r=\"25\" fill=\"cornflowerblue\"/></svg>&nbsp;di richtigi Farb'}function j(e){let t;t='1'===e?'wordguessr?new':'2'===e?'wordguessr?exit':'wordguessr?word='+_.value;let s=new XMLHttpRequest;s.onreadystatechange=function(){if(4===this.readyState&&200===this.status){let e=JSON.parse(s.responseText);0===e.score?(_.classList.add('error'),setTimeout((function(){_.classList.remove('error'),_.value=''}),100)):1===e.score&&(f+=e.score,L('scoreWordGuessr').innerHTML=f+' hesch usegfunde.',_.classList.add('ok'),setTimeout((function(){_.classList.remove('ok'),_.value=''}),100))}},s.open('GET',t,!0),s.send()}setInterval((function(){e=new Date,a&&(e.getHours()>=22||e.getHours()<7)?B.classList.add('d'):B.classList.remove('d'),s!==e.getMinutes()&&(s=e.getMinutes(),v.classList.remove(...v.classList),0!==n&&(s>=55?v.classList.add('M5','MV'):s>=50?v.classList.add('M10','MV'):s>=45?v.classList.add('M15','MV'):s>=40?v.classList.add('M20','MV'):s>=35?v.classList.add('M5','MA','M30'):s>=30?v.classList.add('M30'):s>=25?v.classList.add('M5','MV','M30'):s>=20?v.classList.add('M20','MA'):s>=15?v.classList.add('M15','MA'):s>=10?v.classList.add('M10','MA'):s>=5&&v.classList.add('M5','MA'),t=e.getHours(),s>=25&&(t+=1),t%=12,v.classList.add('H'+t.toString()),v.classList.add('M'+(s%5).toString())))}),100),L('power').addEventListener('click',(function(){N(1-n),X()})),L('settings').addEventListener('click',(function(){q(M,b)})),L('settingsClose').addEventListener('click',(function(){R(M,b),b.classList.remove('swipe-out-right'),X()})),L('playSnake').addEventListener('click',(function(){q(b,k),J(5)})),L('exitSnake').addEventListener('click',(function(){R(b,k),J(6)})),L('playMastermind').addEventListener('click',(function(){q(b,E),U(1)})),L('exitMastermind').addEventListener('click',(function(){R(b,E),U(2)})),L('sendMastermind').addEventListener('click',U),L('playWordGuessr').addEventListener('click',(function(){q(b,y),j('1'),f=0,L('scoreWordGuessr').innerHTML=''})),L('exitWordGuessr').addEventListener('click',(function(){R(b,y),j('2')})),L('sendWordGuessr').addEventListener('click',j),Array.from(document.getElementsByClassName('snakeButton')).forEach((function(e){e.addEventListener('click',(function(e){J(e.target.getAttribute('data-num'))}))})),Array.from(I).forEach((function(e){e.addEventListener('click',(function(e){Array.from(I).forEach((function(e){e.classList.remove('g')})),e.target.classList.add('g'),g=e.target.getAttribute('data-num')}))})),Array.from(C).forEach((function(e){e.addEventListener('click',(function(e){e.target.setAttribute('data-num',g),K()}))})),document.onkeydown=function(e){let t=0;switch(e.key){case'ArrowUp':t=1;break;case'ArrowRight':t=2;break;case'ArrowDown':t=3;break;case'ArrowLeft':t=4;break;case'Enter':y.classList.contains('swipe-in')&&j()}t&&k.classList.contains('swipe-in')&&(J(t),L('control').children[t-1].classList.add('g'),setTimeout((function(){L('control').children[t-1].classList.remove('g')}),200))},A.addEventListener('change',(e=>{W(A.value)}),!1),T.addEventListener('click',(e=>{O(1-r)})),x.addEventListener('click',(e=>{D(1-i)})),H.addEventListener('click',(e=>{V(1-a)})),h('wc_color')&&(A.value=h('wc_color'),W(A.value)),h('wc_rainbow')&&O(parseInt(h('wc_rainbow'))),h('wc_ghost')&&D(parseInt(h('wc_ghost'))),h('wc_dark')&&V(parseInt(h('wc_dark'))),h('wc_speed')&&(S.value=parseInt(h('wc_speed'))),h('wc_score')&&(u=h('wc_score')),L('iphone').href=L('icon').href;const F=['qwMASCHAbSdyWORDuCLOCK','qwMASCHAbSdmSNAKExlbdk','qwMASCHAbSdMASTERMINDk','qwMASCHAbSdWORDbGUESSR'];if(Array.from(document.getElementsByClassName('title')).forEach((function(e,t){for(let s=0;s<22;s++){const n=document.createElementNS('http://www.w3.org/2000/svg','text');let a=F[t].substring(s,s+1),i=a.toUpperCase();n.setAttribute('x',s%11*10+7),n.setAttribute('y',10*Math.ceil((s+1)/11)),n.textContent=i,a===i&&n.setAttribute('class','g'),e.appendChild(n)}})),window.location.href.includes('192.168.')||window.location.href.includes('.local')){let e=new XMLHttpRequest;e.onreadystatechange=function(){if(4===this.readyState&&200===this.status){let a=JSON.parse(e.responseText);a.rainbow||(A.value=(t=a.red,s=a.green,n=a.blue,'#'+(1<<24|t<<16|s<<8|n).toString(16).slice(1))),W(A.value),V(a.darkmode),O(a.rainbow),D(a.ghost),N(a.power),S.value=a.speed}var t,s,n},e.open('GET','get_params',!0),e.send()}else L('snakeBody').classList.add('hide'),L('mastermindBody').classList.add('hide'),L('wordGuessrBody').classList.add('hide')}();</script></body></html>");
            }
